...
function set_ids(){
	...
	if [ "${os}" = "Darwin" ]; then
		if [ "${arch}" = "arm64" ]; then
			...
			bottom_id="https://drive.google.com/file/d/1a7bB25JkOGkhICUKmqPGpKlcBOZAEskM/view?usp=sharing"
		...
		if [ "${arch}" = "x86_64" ]; then
			...
			bottom_id="https://drive.google.com/file/d/1CVebWFC-PTV3hVihNdHwoIZe-m5ls2sp/view?usp=sharing"
